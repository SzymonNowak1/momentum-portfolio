...
def main():
    ...
    # --- 2. Momentum TOP5 dla US universe (jeśli BULL) ---
    top5 = None
    ...
    # --- 3. FX do PLN ---
    print("\n[FX] Loading FX rates (USD/PLN, EUR/PLN)...")
    ...
    print("[FX] Today's FX row:")
    print(fx_today)

    # --- 4. Docelowa alokacja portfela w PLN + lokalna waluta ---
    # Na razie załóżmy testowo, że kapitał = 100 000 PLN
    test_equity_pln = 100_000.0
    ...
    print("\n[Portfolio] Target allocation for equity = 100 000 PLN:")
